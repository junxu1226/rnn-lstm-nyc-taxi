...
df_each = (pd.read_csv(f, index_col = False, header=0, usecols=[2, 7, 8], parse_dates=[0], infer_datetime_format=True, names=['Dropoff_datetime', 'Dropoff_longitude', 'Dropoff_latitude'], memory_map=True) for f in all_files)

# pickups usecols=[1, 5, 6]
# dropoff usecols=[2, 7, 8]
