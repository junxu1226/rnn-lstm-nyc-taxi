...
original_longitude = input_dataset[:, index, 0]


# latitude = latitude[latitude > 0.5]
# latitude = latitude[latitude < 4]
original_latitude = input_dataset[:, index, 1]
#
#
...
class Index(object):
    ...
    def next(self, event):
        ...
        original_longitude = input_dataset[:, self.index, 0]

        original_latitude = input_dataset[:, self.index, 1]
